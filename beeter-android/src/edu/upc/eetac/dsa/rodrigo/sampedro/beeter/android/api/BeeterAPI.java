...
public class BeeterAPI {
	...
	public StingCollection getStings(URL url) {
		...
		try {
			...
			//indicmaos que de la parte entre corchetes de json me coja el array denominado links
			JSONArray jsonLinks = jsonObject.getJSONArray("links");
			//me pone lso elementos del array en el arraylist definido en sting collectionpara loslinks
